...
public final class TransferBurst {
    ...
    public static void main(String[] args) {
        ...
        Collection<Thread> users = setupTransferers1(system);
    ...
    private final static Collection<Thread> setupTransferers1(StorageSystem system) {
    ...
    private final static Collection<Thread> setupTransferers2(StorageSystem system) {
        // FIXME: debug/
        ArrayList<Thread> transferer = new ArrayList<>();
        transferer.add(new Thread(new Runnable() {
            @Override
    ...
    private final static Collection<Thread> setupTransferers3(StorageSystem system) {
        ArrayList<Thread> transferer = new ArrayList<>();
        transferer.add(new Thread(new Runnable() {
            @Override
            public void run() {
